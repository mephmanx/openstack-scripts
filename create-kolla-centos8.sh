...
echo "echo 'export EXTERNAL_VIP=$EXTERNAL_VIP' >> /tmp/global_addresses.sh;" >> /tmp/dns_hosts
echo "echo 'export INTERNAL_VIP=$INTERNAL_VIP' >> /tmp/global_addresses.sh;" >> /tmp/dns_hosts
echo "echo 'export EXTERNAL_VIP_DNS=$EXTERNAL_VIP_DNS' >> /tmp/global_addresses.sh;" >> /tmp/dns_hosts
echo "echo 'export INTERNAL_VIP_DNS=$INTERNAL_VIP_DNS' >> /tmp/global_addresses.sh;" >> /tmp/dns_hosts
