...
echo "echo '192.168.1.253 app-internal.lyonsgroup.family' >> /etc/hosts;" >> /tmp/dns_hosts
echo "echo '192.168.1.104 cloudsupport.lyonsgroup.family' >> /etc/hosts;" >> /tmp/dns_hosts
####
######### Openstack VM types
