...
echo "echo '192.168.1.252 app-external.lyonsgroup.family' >> /etc/hosts;" >> /tmp/dns_hosts
echo "echo '10.0.20.254 app-internal.lyonsgroup.family' >> /etc/hosts;" >> /tmp/dns_hosts
#########################
