...
GRUB_CMDLINE_LINUX="crashkernel=auto resume=/dev/mapper/cs_${DRIVE_NAME_UPDATE}-swap rd.lvm.lv=cs_${DRIVE_NAME_UPDATE}/root rd.lvm.lv=cs_${DRIVE_NAME_UPDATE}/swap net.ifnames=0 intel_iommu=on rhgb quiet splash"
