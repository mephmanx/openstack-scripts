...
# Print usage
usage() {
  echo -n "${scriptName} [OPTION]... --[build/destroy] --[esxi/kvm] --[openstack/cloudsupport]
...
This script is used to build or teardown Openstack environments
 ...
 ${bold}Options:${reset}
  ...
  -o, --hostname    Hostname of hypervisor system
...
while [[ $1 = -?* ]]; do
  case $1 in
    ...
    -d|--debug) debug=true;;
    -o|--hostname) shift; hypervisor_host=${1};;
    --force) force=true ;;
    --endopts) shift; break ;;
    --build) build="true";;
    --destroy) build="false";;
    ...
    --kvm) hypervisor="kvm";;
    --openstack) system="openstack";;
    --cloudsupport) system="cloudsupport";;
