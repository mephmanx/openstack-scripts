  ...
  case $option in
    "control")
        echo '{
            ...
            "network_string":"Openstack-External-Static,Openstack-External-Static"
          }'
    ;;
    "network")
        echo '{
            ...
            "network_string":"Openstack-External-Static,Openstack-External-Static,Openstack-External-Static"
          }'
    ;;
    "compute")
        echo '{
    ...
    "monitoring")
        echo '{
            ...
            "network_string":"Openstack-External-Static"
          }'
    ;;
    "storage")
        echo '{
