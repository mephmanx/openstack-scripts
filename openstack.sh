...
## HP-Disk pool
virsh pool-define-as HP-Disk logical - - /dev/sdb libvirt_lvm  /dev/libvirt_lvm_hpdisk
virsh pool-build HP-Disk
virsh pool-start HP-Disk
virsh pool-autostart HP-Disk

## HP-SSD pool
virsh pool-define-as HP-SSD logical - - /dev/sdc libvirt_lvm  /dev/libvirt_lvm_hpssd
