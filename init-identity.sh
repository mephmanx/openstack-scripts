...
runuser -l root -c "ipa dnszone-mod example.com. --dynamic-update=TRUE"
runuser -l root -c "ipa dnszone-mod example.com. --update-policy='grant $REALM_NAME krb5-self * A; grant $REALM_NAME krb5-self * AAAA; grant $REALM_NAME krb5-self * SSHFP;'"
runuser -l root -c "ipa dnszone-mod example.com. --allow-sync-ptr=TRUE"
